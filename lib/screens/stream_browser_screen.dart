  ...
  Widget _buildStreamContent() {
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        // La lista y su orden los decide el servicio, no esta pantalla.
        // Antes el filtro estaba escrito aqui dentro y el televisor no lo
        // tenia, asi que las dos pantallas enseñaban categorias distintas.
        final displayCategories = _m3uService.categoriasParaMostrar();
