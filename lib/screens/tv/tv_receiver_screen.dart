...
class _TvReceiverScreenState extends State<TvReceiverScreen> {
  ...
  Future<void> _handleLoad(Map<String, dynamic> msg) async {
    ...
    // isScrapeado: viene del teléfono vía protocolo, o se detecta aquí si el TV resuelve solo.
    bool isScrapeado = msg['isScrapeado'] == true;
          ...
          if (esHls) {
            if (isLive) {
              ...
              await mpv.setProperty(
                'hls-bitrate',
                TvMpvConfig.hlsBitrate(esScrapeado: isFromDB),
              );
